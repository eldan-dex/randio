...
namespace Randio_2 {
    ...
    class Game : Microsoft.Xna.Framework.Game {
        ...
        private void DrawOSDs()
        {
            ...
            osdSpriteBatch.DrawString(font, "WSAD - move    J - attack    K - pick/put item    L - reset    LSHIFT - slowdown   ESC - end level", new Vector2(10, 700), invColor, 0f, Vector2.Zero, 0.8f, SpriteEffects.None, 0f);
            osdSpriteBatch.End();
        }
